...
import org.apache.spark.streaming.dstream.{DStream, ReceiverInputDStream, SelfReducedWindowedDStream}
...
object AdClickRealTimeStateSpark {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val formattedDStream: DStream[AdClickRecord] = this.formattedAdRealTimeDStreamData(dstream)
  ...
  def filterByBlackList(dstream: DStream[AdClickRecord]): DStream[AdClickRecord] = {
    dstream.transform(rdd => {
      ...
      rdd
        ...
        .leftOuterJoin(blackListRDD)  //(userid,(record,count))  =>(a01,(record,200)) (a02,(record,null))
        .filter(_._2._2.isEmpty)
        .map(_._2._1)
    })
  }
